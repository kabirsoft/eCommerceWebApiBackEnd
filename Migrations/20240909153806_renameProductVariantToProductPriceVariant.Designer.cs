...
namespace eCommerceWebApiBackEnd.Migrations
{
    ...
    [Migration("20240909153806_renameProductVariantToProductPriceVariant")]
    partial class renameProductVariantToProductPriceVariant
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eCommerceWebApiBackEnd.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eCommerceWebApiBackEnd.Models.ProductPriceVariant", b =>
                {
            ...
            modelBuilder.Entity("eCommerceWebApiBackEnd.Models.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eCommerceWebApiBackEnd.Models.Product", b =>
                {
                    b.HasOne("eCommerceWebApiBackEnd.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("eCommerceWebApiBackEnd.Models.ProductPriceVariant", b =>
                {
                    b.HasOne("eCommerceWebApiBackEnd.Models.Product", "Product")
                        .WithMany("ProductPriceVariant")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eCommerceWebApiBackEnd.Models.ProductType", "ProductType")
                        .WithMany()
            ...
            modelBuilder.Entity("eCommerceWebApiBackEnd.Models.Product", b =>
                {
                    b.Navigation("ProductPriceVariant");
                });
